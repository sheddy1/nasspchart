...
<body>
    ...
    <?php
          ...
          $no1= $con1b;
            ...
            echo "
                <form>
                    ...
                    <button name='btn-chart' type='submit' class='btn-chart' >
                        Create Chart
                    </button>
        ...
        if(isset($_POST['btn-chart']))
        {
            ...
            //         ('$closed','$name','$month','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open','$open')";
