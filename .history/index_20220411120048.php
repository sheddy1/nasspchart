        ...
        else if($page == 2)
        {
            ...
            if($edit_chart == 2)
            {
                ...
                for($x = 0; $x<$no1; $x++)
                {
                    ...
                    echo"
                        <div id='pictures'>
                            <label class='slidephotos'>$name_table</label>
                    ...
                    //            echo $name_table
                    //      <form method='POST' action=''>
                    //         <button class='select_name' name='sheddy1'>
                    //         </button>
                    //     </form>
                    //  ";
                ...
                echo"
                <img src='images/download' class='sliderleft'  onclick='plusDivs(-1)'>

                <img src='images/download' class='sliderright'  onclick='plusDivs(-1)'>
                ";
                ...
                if(isset($_POST['sheddy1']))
                     {
                        echo"<script>alert('$table_name');</script>";
                     }
