        ...
        else if($page == 2)
        {
            ...
            if($edit_chart == 2)
            {
                ...
                if(isset($_POST['set_date']))
                {
                    ...
                    echo"<script>alert($names_lenght_row);</script>";

                    $y = $start_date;

                    $end_date = $_POST['end_date'];

                    // $change = "UPDATE employees SET `14`='closed' WHERE id='$name_id'";

                    // mysqli_query($db,$change);

                    // for($x=0; $x<$names_lenght_row;$x++)
                    // {
                    //     $names_get = mysqli_fetch_array($run_names_lenght);
                    //     $name_id = $names_get['id'];
                    //     for($i=$start_date;$i<=$end_date;$i++)
                    //     {
                    //         $change = "UPDATE employees SET `$start_date`='closed' WHERE id='$name_id'";
                    //         $y++;
                    //     }
                    // }
