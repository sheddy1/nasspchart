        ...
        echo "
                    <form method='POST' action=''>
                        ...
                        <div class='remove_name_id'>
                            <input type='text' class='remove_name_text' name='remove_name_text' placeholder='Input staff id'>
                            <button type='submit' class='insert_name_button' name='remove_name_button'>Add employee</button>
                	    </div>
                    </form>        
                ";
